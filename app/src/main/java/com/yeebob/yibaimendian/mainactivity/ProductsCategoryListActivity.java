...
public class ProductsCategoryListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCategoryAdapter.setOnItemClickLitener(new CategoryAdapter.OnItemClickLitener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                if (mDatas.get(position).getCat_id() >= 0) {
                    Intent intent = new Intent(ProductsCategoryListActivity.this, ProductsListActivity.class);
            ...
            public void onItemLongClick(View view, int position) {
                Toast.makeText(ProductsCategoryListActivity.this, position + " long click",
        ...
        shopQrcode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ProductsCategoryListActivity.this, ShowShopQrcode.class);
    ...
    private void getDates(String catId) {

        shopId = (Integer) SharedPreferencesUtil.getData(ProductsCategoryListActivity.this, "shopid", 0);
        token = (String) SharedPreferencesUtil.getData(ProductsCategoryListActivity.this, "token", "");
